...
class StaffAuthBackend:
    ...
    QUICK_ROLES = {
        ...
        'fs':          {'pass': 'fs001', 'id': 2, 'username': 'FS001', 'role_id': 2, 'role_name': 'Field Supervisor'},
        ...
        'sn1':         {'pass': 'sf001', 'id': 3, 'username': 'SN001', 'role_id': 3, 'role_name': 'Staff Nurse'},
        ...
        'couns':       {'pass': 'co001', 'id': 5, 'username': 'C001', 'role_id': 5, 'role_name': 'Counselor'},
