...
$this->params['menu'] = [
	...
	['label' => '<i class="glyphicon glyphicon-eye-open"></i>', 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'View'], 'url' => ['view', 'id' => $model->mortality_form_id]],
...
?>
<div class="mortalityform-update">
