...
$this->params['menu'] = [
	...
	['label' => FA::icon('pencil fa-fw'), 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'Update'], 'url' => ['update', 'id' => $model->apm_id]],
	['label' => FA::icon('trash fa-fw'), 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'Delete', 'data' => ['confirm' => Yii::t('app', 'Are you sure you want to delete this item?'), 'method' => 'post']], 'url' => ['delete', 'id' => $model->apm_id]],
];
?>
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
			// 'apm_id',
	         ...
	         [		   
		        'attribute'=>'apm_survey',
	            'value'=>Surveymaster::find()->where(["=","sur_code", $model->apm_survey])->one()->sur_title,
