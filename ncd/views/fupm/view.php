...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Fupms'), 'url' => ['index']];
...
$this->params['menu'] = [
	...
	['label' => FA::icon('pencil fa-fw'), 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'Update'], 'url' => ['update', 'id' => $model->fupm_id]],
	['label' => FA::icon('trash fa-fw'), 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'Delete', 'data' => ['confirm' => Yii::t('app', 'Are you sure you want to delete this item?'), 'method' => 'post']], 'url' => ['delete', 'id' => $model->fupm_id]],
];
?>
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
			// 'fupm_id',
             ...
             [		   
		        'attribute'=>'fupm_survey',
	            'value'=>Surveymaster::find()->where(["=","sur_code", $model->fupm_survey])->one()->sur_title,
