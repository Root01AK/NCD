		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-12">
					...
					<?= $form->field($model, 'fld_mstr_frmfield', $template)->dropDownList($model->frmfield, ['prompt'=>$model->getAttributeLabel('fld_mstr_frmfield')]); ?>
					<?= $form->field($model, 'fld_mstr_code', $template)->textInput(['maxlength' => true]) ?>
					<?= $form->field($model, 'fld_mstr_desc', $template)->textInput(['maxlength' => true]) ?>
