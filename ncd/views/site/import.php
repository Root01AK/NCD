        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    ?>
                    <?= $form->field($model, 'name', $template)->dropDownList($list, ['prompt' => $model->getAttributeLabel("name")]) ?>
                    <?= $form->field($model, 'file', $template)->fileInput() ?>
                    <?= $form->field($model, 'clear', $template)->checkbox(['label' => null])->label() ?>
