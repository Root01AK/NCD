   ...
   function change_q19()
	{
          ...
          if($('#mdhl-mdhl_q19').val() == 1 && $('#mdhl-mdhl_q19a').val() == 5) {					
...
$JS = "
	...
	$('#mdhl-mdhl_q6 input[type=checkbox],#mdhl-mdhl_q7,#mdhl-mdhl_q8,#mdhl-mdhl_q9,#mdhl-mdhl_q19').trigger('change');
	
	
	$('#mdhl-mdhl_q19, #mdhl-mdhl_q19a').change(function(){
		change_q19();
	});
	
	$('#mdhl-mdhl_q19, #mdhl-mdhl_q19a').focusout(function(e){
		change_q19();
	});
			      ...
			      <?= Common::generateControl($form, $model, $htemplate, 'mdhl_survey', $Surveys, 'survey', 'getSurveyid') ?>
				   ...
				   <?php if($model->isNewRecord) : ?>						
					...
					<div class="form-group">
						  <div class="col-sm-7">
						      <?= Html::label('GENERAL ANXIETY DISORDER :') ?>
							  <?= Html::label('13. Over the last 2 weeks, how often have you been bothered by any of the following problems?') ?>
						  </div>									 
					</div> 
                ...
                <div class="panel-body">
                   ...
                   <table class="table table-bordered container-items"  border="0" cellpadding="0" cellspacing="0" align="center">
				    ...
				    <?= $form->field($model, 'gad_q8', $template)->dropDownList($model->q8 , ['prompt' => 'Select']) ?>								
	              	...
	              	<div class="form-group">
						  <div class="col-sm-7">
						      <?= Html::label('DEPRESSION SCALE: PATIENT HEALTH QUESTIONNAIRE (PHQ 9) :') ?>
							  <?= Html::label('15. Over the last 2 weeks, how often have you been bothered by any of the following problems?') ?>
						  </div>									 
					</div> 
         ...
         <div class="form-phq">	
                ...
                <div class="panel-body">
			       <div class="row">	
                    ...
                    <?= $form->field($model, 'mdhl_q19a', $template)->dropDownList($model->med3, ['prompt'=>'Select']); ?>							
