			...
			<div class="row">
				<div class="col-lg-12">
				  ...
				  <?php if($model->isNewRecord) : ?>
					<?= $form->field($model, 'staff_code', $template)->textInput(['maxlength' => true]) ?>
				  <?php else: ?>	
					 <?= $form->field($model, 'staff_code', $template)->textInput(['value'=>$model->staff_code,'readonly' => true]) ?> 
				 <?php endif; ?>
					 					
					<?= $form->field($model, 'staff_name', $template)->textInput(['maxlength' => true]) ?>
