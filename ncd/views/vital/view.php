...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Vitals'), 'url' => ['index']];
...
$this->params['menu'] = [
	...
	['label' => FA::icon('pencil fa-fw'), 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'Update'], 'url' => ['update', 'id' => $model->vital_id]],
	['label' => FA::icon('trash fa-fw'), 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'Delete', 'data' => ['confirm' => Yii::t('app', 'Are you sure you want to delete this item?'), 'method' => 'post']], 'url' => ['delete', 'id' => $model->vital_id]],
];
?>
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
			// 'vital_id',
	         ...
	         [		   
		        'attribute'=>'vital_survey',
	            'value'=>Surveymaster::find()->where(["=","sur_code", $model->vital_survey])->one()->sur_title,
