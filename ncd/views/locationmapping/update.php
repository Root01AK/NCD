...
$this->params['menu'] = [
	...
	['label' => '<i class="glyphicon glyphicon-eye-open"></i>', 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'View'], 'url' => ['view', 'id' => $model->loc_mapng_id]],
...
?>
<div class="locationmapping-update">
