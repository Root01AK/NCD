...
$this->params['menu'] = [
	...
	['label' => FA::icon('pencil fa-fw'), 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'Update'], 'url' => ['update', 'id' => $model->cprca_id]],
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
			// 'cprca_id',
	          ...
	          [		   
		        'attribute'=>'cprca_survey',
	            'value'=>Surveymaster::find()->where(["=","sur_code", $model->cprca_survey])->one()->sur_title,
