...
$JS = "
	...
	$(':checkbox:not(.check-all)').click(function() {
		if($(this).attr('id') != 'menuprivileges-status') {
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-12">
					<?php
						$form = ActiveForm::begin(['options' => ['class' => 'form-horizontal', 'id' => 'menuprivileges-form']]);
						$template = [
					...
					<?= $form->field($model, 'mnu_acs_usr_id_fk', $template)->dropDownList($users, ['prompt' => $model->getAttributeLabel("mnu_acs_usr_id_fk"), 'onchange' => 'user_change(this)']) ?>
					<?= $form->field($model, 'mnu_acs_mnu_id_fk', $template)->dropDownList($mainmenus, ['prompt' => "All", 'onchange' => 'main_change(this)']) ?>
