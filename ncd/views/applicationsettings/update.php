...
$this->params['menu'] = [
	...
	['label' => '<i class="glyphicon glyphicon-eye-open"></i>', 'linkOptions' => ['class'=>'btn btn-default', 'title'=>'View'], 'url' => ['view', 'id' => $model->app_stngs_id]],
...
?>
<div class="applicationsettings-update">
