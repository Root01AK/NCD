...
$this->title = 'Tracking Form Report';
...
if(empty($model->frmdate))
    $model->frmdate = $model->getTrackingformstartdate();
                ...
                <div class="col-lg-12">
                    ...
                    <?php if(isset($dataProvider)) : ?>
                        <?= GridView::widget([
                            ...
                            'formatter' => ['class' => 'yii\i18n\Formatter','nullDisplay' => '-', 'dateFormat' => 'dd-MM-Y','datetimeFormat' => 'dd-MM-Y hh:mm:ss'], 					
